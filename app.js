(function(){
  ...
  function render(){
    ...
    renderInsights(r);renderScenarios(s);renderCharts(r);
  }
  ...
  function renderInsights(r){
    ...
    if(r.target.target<=0){
      ...
      els.insightAdjustment.textContent='No portfolio investment indicated';
